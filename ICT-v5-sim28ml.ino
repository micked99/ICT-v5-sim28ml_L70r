...
void setup()
{
  ...
  Serial.begin(9600);
  delay(2000); 
  Serial.write("$PMTK886,3*2B\r\n");  //Sets Balloon mode of SIM28ML
  delay(2000); 
  //Serial.write("$PMTK127*36\r\n");  delay(2000);  //Erase EPO data stored in the flash memory - SIM28ML
  //Serial.write("$PMTK120*31\r\n");  delay(2000);  //Erase aiding data stored in the flash memory - SIM28ML
  //Serial.write("$PMTK104*37\r\n");  delay(2000);  //resets the GNSS module to the factory default - SIM28ML
